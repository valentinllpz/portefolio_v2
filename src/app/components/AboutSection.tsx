      ...
      <div className="flex flex-row space-x-12 items-center">
        <div className="flex flex-col space-y-4">
          ...
          <p>
            ...
            web applications from scratch, from the design to the deployment. I
            am passionate about creating beautiful and efficient applications
            that provide a great user experience. I stand out for my ability to
            solve complex technical problems and adapt quickly to a new
            environment. My versatile background, which includes a career change
            after a Masters in International Business, strengthens my ability to
            identify product needs and collaborate effectively. I am looking for
            new challenges to continue to develop my skills, and I am highly
            motivated by the idea of training in new technologies.
          </p>
        </div>
      </div>
      <div className="flex flex-col space-y-4">
