...
const Section: React.FC<SectionProps> = ({ title, subtitle, children }) => {
  return (
    ...
    >
      <div className="flex flex-col justify-center pl-4 space-y-2 border-l border-light/[0.8] lg:flex-1 lg:sticky lg:top-[45%] lg:text-right lg:border-r lg:border-l-0 lg:pr-12 lg:w-[50%] xl:w-[40%]">
